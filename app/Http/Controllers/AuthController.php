...
class AuthController extends Controller
{
    ...
    public function loginPost(Request $request)
    {
        ...
        if (Auth::attempt($credentials, $remember)) {
            ...
            } elseif ($user->type == 'user' && $user->status == 'approved') {
    ...
    public function registerPost(Request $request)
    {
        ...
        return redirect()->route('auth.login')->withSuccess('Your account has been successfully registered. Please wait until your account is approved by the administrator.');
    }
}
